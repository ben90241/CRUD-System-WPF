...
namespace WpfApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string Name, string Position, string Phone, string Address) {
...
namespace WpfApp1.Database1DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Id], [Name], [Position], [Phone], [Address]) VALUE" +
                "S (@Id, @Name, @Position, @Phone, @Address);\r\nSELECT Id, Name, Position, Phone, " +
                "Address FROM Employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [Name] = @Name, [Position] = @Position, [Phone] = @Phone, [Address] = @Address WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT Id, Name, Position, Phone, Address FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position, Phone, Address FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Position, string Original_Phone, string Original_Address) {
        ...
        public virtual int Insert(int Id, string Name, string Position, string Phone, string Address) {
        ...
        public virtual int Update(int Id, string Name, string Position, string Phone, string Address, int Original_Id, string Original_Name, string Original_Position, string Original_Phone, string Original_Address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, string Phone, string Address, int Original_Id, string Original_Name, string Original_Position, string Original_Phone, string Original_Address) {
            return this.Update(Original_Id, Name, Position, Phone, Address, Original_Id, Original_Name, Original_Position, Original_Phone, Original_Address);
        }
    }
